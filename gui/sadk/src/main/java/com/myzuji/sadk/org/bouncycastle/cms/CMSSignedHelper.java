...
import com.myzuji.sadk.org.bouncycastle.asn1.eac.EACObjectIdentifiers;
...
import com.myzuji.sadk.org.bouncycastle.util.CollectionStore;
...
public class CMSSignedHelper {
    ...
    AlgorithmIdentifier fixAlgID(AlgorithmIdentifier algId) {
        return algId.getParameters() == null ? new AlgorithmIdentifier(algId.getAlgorithm(), DERNull.INSTANCE) : algId;
    }
