...
public class IssuingDistributionPoint extends ASN1Object {
    ...
    public static IssuingDistributionPoint getInstance(Object obj) {
        if (obj instanceof IssuingDistributionPoint) {
            ...
            return obj != null ? new IssuingDistributionPoint(ASN1Sequence.getInstance(obj)) : null;
        }
    }
    ...
    public IssuingDistributionPoint(DistributionPointName distributionPoint, boolean indirectCRL, boolean onlyContainsAttributeCerts) {
        this(distributionPoint, false, false, (ReasonFlags) null, indirectCRL, onlyContainsAttributeCerts);
    }
