...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(ASN1Sequence seq) {
        ...
        ASN1Sequence s;
        for (Enumeration e = seq.getObjects(); e.hasMoreElements(); this.ordering.addElement(s.getObjectAt(0))) {
    ...
    public X509Extensions(Hashtable extensions) {
        this((Vector) null, (Hashtable) extensions);
    }
    ...
    public X509Extensions(Vector objectIDs, Vector values) {
        ...
        for (e = this.ordering.elements(); e.hasMoreElements(); ++count) {
